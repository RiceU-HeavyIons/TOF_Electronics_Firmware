// $Id: TCPU-C_I2C.c,v 1.2 2009-03-06 16:20:05 jschamba Exp $

/* TCPU-C_I2C.c ---------------------------------------------------------------------
**
** Routines to support I2C devices on TCPU-C board
**
** Modified:
**  12-Dec-2008, W. Burton
**      Added routines Read16_Temp() and Write16_Temp() to support temperature alarm.
**  27-Aug-2008, W. Burton
**      Remove reference to TDIG
**
...
** Baud rate is set on the basis of constants defined in file TCPU-C_Board.h
** Call with: nothing
** Returns: nothing
** Hardware effects: I2C #1 Interrupts are disabled;
**      I2C port is opened with baud rate computed from TCPU-C_Board.h
**		I2C is left "Idle"
*/
...
/* This routine writes a value to the DAC at address DAC_ADDR from TCPU-C_Board.h
...
//  initialize_MCP23008 (     addr,     (0)iodir,      (1)ipol,    (2)gpinten,     (3)defval,     (4)intcon,      (5)iocon,      (6)gppu)
    Initialize_MCP23008 (ECSR_ADDR,   ECSR_IODIR, ECSR_IOINV, MCP23008_NONE, MCP23008_NONE, MCP23008_NONE, MCP23008_ALL, ECSR_IOPUP);
//  Write_device_I2C1 (ECSR_ADDR, MCP23008_OLAT, MCP23008_NONE);     // No WRITE, all are inputs.
}
...
*/
//  initialize_MCP23008 (     addr, iodir(all in), ipol(all invert),       gpinten,        defval,        intcon,         iocon, gppu (all PU)
