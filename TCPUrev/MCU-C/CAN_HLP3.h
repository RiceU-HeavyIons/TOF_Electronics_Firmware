/* $Id: CAN_HLP3.h,v 1.4 2009-09-02 14:51:29 jschamba Exp $ */
/* CAN_HLP3.h
...
**      TEMPALERTS_LEN and TEMPALERTS_INTERVAL values are conditional on whether TDIG or TCPU is being
**      built.
**  10-Dec-2008, W. Burton
**      Add C_WS_TOGGLETINO == Toggle_TINO_TEST_MCU line function to CANBus protocol.
**      Add C_WS_TEMPALERTS == Temperature ALERT Limits
...
// byte-0 of Payload codes (C_WRITE SubCommands)
    ...
    #define C_WS_TEMPALERTS   0x09      // Write-to-Temperature ALERT limit.
...
// WB-2G: Length of TEMPALERTS and interval between is conditional on TDIG or TCPU definition
