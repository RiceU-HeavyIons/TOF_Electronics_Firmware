// $Id: TCPU-B_Board.h,v 1.1 2008-02-13 17:44:42 jschamba Exp $

/* TCPU-B_Board.h
** This header file defines the TCPU-B rev 0 board layout per schematic
**  dated March 20, 2007.
**  It defines:
...
**
**  Modified:
**     17-Oct-2007, W. Burton
**          Define DOWNLOAD_CODE for building a downloadable version
...
//     #define DAC_ADDR 0x98           // I2C Addrs of chip (NOT ON TCPU-B)
	#if defined (DAC_ADDR)
...
/* Port D bits used for various control functions */
    #define PLL_RESET (LATDbits.LATD0)
    #define PLL_LOL (LATDbits.LATD1)
...
/* Port G bits used for various control functions */
    ...
    #define MCU_SEL_TERM2 (LATGbits.LATG13)
    #define PLD_DEVOE (LATGbits.LATG12
    #define MCU_SEL_TERM1 (LATGbits.LATG9)
    ...
    #define PORTG_initial 0xDDFF;   // Default NO CAN TERMs.
