// $Id: TCPU-B_CAN_HLP3.h,v 1.1 2008-02-13 17:44:42 jschamba Exp $
...
**
**
** 16-Oct-2007, W. Burton
**    Reconciled TCPU board ID (C_TDIG) with HLP document.
** 28-Sep-2007, W. Burton
**    Add definition of C_EXT_ID_BIT for extended ID flag
** 25-Sep-2007, W. Burton
**    Copied over from TDIG-F_CAN_HLP3.h
**    Updated for board address and move definitions in from TCPU main code.
...
** 2nd nibble: 4-bits of board ID (position switch)
...
// Destination Codes (Address)
    #define C_BOARD (0x200<<2)             // Node ID is 32+switch_setting
...
// Payload of "alert" message
    #define C_ALERT_ONLINE 0x000000FFL
