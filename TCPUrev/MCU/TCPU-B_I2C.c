// $Id: TCPU-B_I2C.c,v 1.1 2008-02-13 17:44:42 jschamba Exp $

/* TCPU-B_I2C.c ---------------------------------------------------------------------
**
** Routines to support I2C devices on TCPU-B board
**
...
// Define implementation on the TDIG board (I/O ports, etc)
	...
	#include "TCPU-B_I2C.h"

/* I2C_Setup() ----------------------------------------------------------------------
** This routine disables I2C Interrupts and sets up the configuration of the I2C #1
** Baud rate is set on the basis of constants defined in file TCPU-B_Board.h
** Call with: nothing
** Returns: nothing
** Hardware effects: I2C #1 Interrupts are disabled;
**      I2C port is opened with baud rate computed from TCPU-B_Board.h
**		I2C is left "Idle"
*/
...
/* This routine writes a value to the DAC at address DAC_ADDR from TCPU-B_Board.h
